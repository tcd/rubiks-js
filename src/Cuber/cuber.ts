...
(function () {
    ...
    */
    ...
    THREE.Math = {
        ...
        radToDeg: function () {
            let radianToDegreesFactor = 180 / Math.PI
    ...
    THREE.Vector3.prototype = {
        ...
        setFromMatrixScale: function (m) {
            let sx = this.set(m.elements[0], m.elements[1], m.elements[2]).length()
            let sy = this.set(m.elements[4], m.elements[5], m.elements[6]).length()
            let sz = this.set(m.elements[8], m.elements[9], m.elements[10]).length()
            this.x = sx
            this.y = sy
            this.z = sz
            return this
    ...
    */
    ...
    let _ = {
        ...
        cascade: function () {
            let i, args = Array.prototype.slice.call(arguments)
    ...
    */
    ...
    // anywhere in any scope without big long letiables names full of dots and
    ...
    */
     ...
     *
     * If `Cube.isSolving` === true then within that loop Cube will call `window.solver.consider(cube)`.
     * This means when you create your own `Solver` instance you have to set window.solver equal to your instance.
     *
     ...
     * made and the `logic()` should be run again in the next loop;
     * For example, run again after a twist queue completes.
     *
     * --
     *
     * @author Mark Lundin - http://www.mark-lundin.com
